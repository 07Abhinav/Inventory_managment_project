                ...
                {Suppliers.map((element, i) => (
                    <div className='Suppliers-column'>
                        ...
                        <div className='Action'>
                            <img src='https://cdn-icons-png.flaticon.com/512/2951/2951136.png' alt={`${element.Supplier}`} width="25" id={`${element.Contact}`} style={{ marginRight: "10px" }} onMouseOver={(e) => e.target.src = 'https://cdn-user-icons.flaticon.com/96885/96885753/1679324986249.svg?token=exp=1679325887~hmac=f9b64a85b2593f9e72b57fdc29fb66fe'} onMouseOut={(e) => e.target.src = 'https://cdn-icons-png.flaticon.com/512/2951/2951136.png'} onClick={(e) => { document.documentElement.style.setProperty('SS', 'flex'); setUpdate1(e.target.alt); setUpdate2(e.target.id); setSupplier(e.target.alt); setContact(e.target.id);}} />
                            <img src='https://cdn-icons-png.flaticon.com/512/1214/1214428.png' alt={`${element.Supplier}`} width="20" onMouseOver={(e) => e.target.src = 'https://cdn-user-icons.flaticon.com/96885/96885753/1679326938798.svg?token=exp=1679327844~hmac=683d30cc114a5ff3c841cca8421d252f'} onMouseOut={(e) => e.target.src = 'https://cdn-icons-png.flaticon.com/512/1214/1214428.png'} onClick={deleteSupplier} />
                        </div>
                    </div>
                ))}
            </div>
