    ...
    return (
      <div className='LowStock'>
        <div className='Header'>
          <div className='Name'><img src='https://cdn-user-icons.flaticon.com/96885/96885753/1679321351604.svg?token=exp=1679322252~hmac=60974dc39c6b4c238b4bf00fed2fac31' width='25' alt='' style={{marginRight: "1rem"}}/>Out Of Stock</div>
        </div>
        ...
        <div className="list">
        {products.filter((e) => e.inStock < 1).map((element, i) => (
