          ...
          {products.map((element, i) => (
            <div className='list-column'>
              ...
              <div className='Action'>
                <Link to='/UpdateProduct' state={{value: element}}><img src='https://cdn-icons-png.flaticon.com/512/2951/2951136.png' alt='' width="25" style={{marginRight: "10px"}} onMouseOver = {(e) => e.target.src = 'https://cdn-user-icons.flaticon.com/96885/96885753/1679324986249.svg?token=exp=1679325887~hmac=f9b64a85b2593f9e72b57fdc29fb66fe'} onMouseOut = {(e) => e.target.src = 'https://cdn-icons-png.flaticon.com/512/2951/2951136.png'}/></Link> 
